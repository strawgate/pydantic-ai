    ...
    steps:
      - name: Check out the default prompt file
        ...
        with:
          ...
          sparse-checkout: .github/workflows/shared/prompts/pydantic-ai-regression-detector.md
      ...
      - name: Resolve agent prompt (Logfire managed variable, else committed default)
        ...
        env:
          ...
          LOGFIRE_VARIABLE_KEY: gh_aw_pydantic_ai_regression_detector_prompt
          TARGETING_KEY: gh-aw-${{ github.repository }}
          DEFAULT_PROMPT_FILE: .github/workflows/shared/prompts/pydantic-ai-regression-detector.md
        run: |
          set -euo pipefail
