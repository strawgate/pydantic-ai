...
description: "Find serialize/deserialize state-loss bugs across a message round-trip boundary and file a reproducible report. Runs on the Pydantic AI harness engine; the prompt is iterable from a Logfire managed variable."
    ...
    steps:
      - name: Check out the default prompt file
        ...
        with:
          ...
          sparse-checkout: .github/workflows/shared/prompts/pydantic-ai-roundtrip-sweep.md
      ...
      - name: Resolve agent prompt (Logfire managed variable, else committed default)
        ...
        env:
          ...
          LOGFIRE_VARIABLE_KEY: gh_aw_pydantic_ai_roundtrip_sweep_prompt
          TARGETING_KEY: gh-aw-${{ github.repository }}
          DEFAULT_PROMPT_FILE: .github/workflows/shared/prompts/pydantic-ai-roundtrip-sweep.md
        run: |
          set -euo pipefail
