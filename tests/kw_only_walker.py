...
The fixture pauses coverage while it walks the package. Missing optional dependencies execute
`pragma: no cover` import guards, which would otherwise fail the strict pragma audit.
